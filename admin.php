...
<html>
	...
	<tr>
			...
			<td>
				...
				<a href="admin_favorite.inc.php?house_id=<? echo $row['id']; ?>">Favorite</a>
				
				<?}?>
				<a href="admin_order_page.php?id=<? echo $row['id']; ?>">Order</a>
				<a href="admin_delete.inc.php?house_id=<? echo $row['id']; ?>">Delete</a>
			<?}?>
