...
<button  onclick="location.href='new_house.php'">New</button>
	<button  onclick="location.href='edit_house.php'">Edit</button>
</section>
	...
	<tr>
		<?if($row['owner_id']==$_SESSION['u_id']){?>
			...
			<td><a href="house_management_delete.inc.php?id=<? echo $row['id']; ?>">Delete</a></td>
		<?}?>
	</tr>
	<?}?>
</table><?}?>
