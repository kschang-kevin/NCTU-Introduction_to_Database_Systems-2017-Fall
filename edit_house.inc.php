...
<head>
	...
	<section class="main-container">
		<div class="main-wrapper">
			<h2>Edit House</h2>
			<form class="newhouse-form" action="edit_house.inc.inc.php?id=<? echo $_GET['id'] ?>" method="POST">
			...
			<button class="cancel" onclick="location.href='edit_house.php'">Cancel</button>
		</section>
		</div>
	</section>
<?php
