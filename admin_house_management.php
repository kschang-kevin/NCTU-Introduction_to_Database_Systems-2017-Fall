...
<button  onclick="location.href='admin_new_house.php'">New</button>
	<button  onclick="location.href='admin_edit_house.php'">Edit</button>
</section>

	

	<section class="main-container">
		<div class="login"><h2>House Management</h2>
	...
	<tr>
		<?if($row['owner_id']==$_SESSION['u_id']){?>
			...
			<td><a href="admin_house_management_delete.inc.php?id=<? echo $row['id']; ?>">Delete</a></td>
		<?}?>
	</tr>
	<?}?>
</table><?}?>
